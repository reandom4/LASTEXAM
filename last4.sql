...
--
-- Table structure for table `clientscar`
--

DROP TABLE IF EXISTS `clientscar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `clientscar` (
  `idClientsCar` int(11) NOT NULL AUTO_INCREMENT,
  `CarNumber` varchar(45) NOT NULL,
  `CarBrand` varchar(45) NOT NULL,
  `CarModel` varchar(45) NOT NULL,
  `CarDate` varchar(45) NOT NULL,
  `CarHorsePower` varchar(45) NOT NULL,
  `CarIdentifier` varchar(45) NOT NULL,
  `CarIdentifierNumber` varchar(45) NOT NULL,
  `CarDocument` varchar(45) NOT NULL,
  `CarDocumentNumber` varchar(45) NOT NULL,
  `CarDocumentDate` varchar(45) NOT NULL,
  PRIMARY KEY (`idClientsCar`),
  UNIQUE KEY `CarDocumentNumber_UNIQUE` (`CarDocumentNumber`),
  UNIQUE KEY `CarIdentifierNumber_UNIQUE` (`CarIdentifierNumber`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `clientscar`
--

LOCK TABLES `clientscar` WRITE;
/*!40000 ALTER TABLE `clientscar` DISABLE KEYS */;
INSERT INTO `clientscar` VALUES (17,'А123АА 123','Acura','CDX','2002','120','VIN','23112331311233121','ПТС','2312312312','14:24:1242'),(19,'А123АА 123','Alfa Romeo','CL','2012','120','VIN','12231231111333333','ПТС','1230192430','09:24:9082');
/*!40000 ALTER TABLE `clientscar` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `driver` (
  ...
  UNIQUE KEY `idClient_UNIQUE` (`idDriver`)
...
INSERT INTO `driver` VALUES (1,'Максим','Максименко','Максимов',5,1,'69ОК647384','12.12.2000'),(2,'Антон','Антонов','Антонович',3,0,'45ОК657384','12.12.1998'),(3,'Николай','Николаев','Николаевич',12,0,'21ОК345723','05.02.1984'),(5,'Арнольд','Андреев','Дамирович',22,1,'7701397000','22.08.1970'),(6,'Филипп','Моисеев','Гордеевич',29,2,'74АА397530','12.06.1968'),(7,'Владлен','Голубев','Богуславович',53,1,'36РА784534','26.06.2000'),(8,'Карл','Афанасьев','Владимирович',57,2,'32АА782323','29.03.1997'),(10,'Владимир','Шестаков','Агафонович',58,0,'32АА643235','15.09.1981'),(11,'Леонтий','Егоров','Александрович',27,0,'32АА823675','15.09.1987'),(12,'Арсений','Дмитриев','Аркадьевич',35,0,'32АА124654','18.05.1983'),(13,'Сергей','Шестаков','Николаевич',37,0,'32АА754345','14.12.1966'),(14,'Венедикт','Беляков','Георгиевич',11,0,'32АА124421','01.01.1976'),(15,'Альфред','Константинов','Агафонович',50,0,'32АА643634','23.07.2001'),(16,'Вениамин','Брагин','Егорович',29,1,'32АА634623','09.12.1986'),(17,'Гордей','Зайцев','Олегович',4,2,'32АА634612','31.05.1968'),(18,'Герман','Борисов','Анатольевич',15,1,'32АА543534','31.03.1979'),(19,'Аскольд','Ширяев','Геннадиевич',18,5,'32АА232232','25.03.1998'),(20,'Винетта','Соболева','Егоровна',58,0,'32АА234324','01.11.1993'),(21,'Роксана','Устинова','Христофоровна',15,0,'32АА543234','26.08.1979'),(22,'Моника','Васильева','Якуновна',41,0,'32АА654345','24.05.1994'),(23,'Августа','Михеева','Никитевна',41,0,'32АА646456','26.10.1981'),(24,'Нания','Пономарёва','Якововна',55,0,'32АА235235','28.04.1977'),(25,'Тереза','Комиссарова','Давидовна',23,0,'32АА532523','25.12.1997'),(26,'Любава','Андреева','Валентиновна',18,1,'32АА423423','05.02.1974'),(27,'Ксения','Ефремова','Михайловна',14,2,'32АА123321','05.11.1964'),(28,'Наталия','Моисеева','Романовна',53,3,'32АА543537','11.08.2001'),(29,'Женевьева','Капустина','Вадимовна',1,1,'32АА453534','14.01.1980'),(30,'Данута','Панфилова','Гордеевна',24,2,'32АА097435','03.02.1982'),(31,'Эдилия','Устинова','Эдуардовна',51,1,'32АА765434','24.05.1962'),(32,'Гера','Копылова','Максимовна',1,2,'32АА645363','16.11.1980'),(33,'Анастасия','Кабанова','Прокловна',39,0,'32АА356356','17.06.1988'),(34,'Дария','Кабанова','Эльдаровна',35,1,'32АА123543','01.07.1962'),(46,'Д','Юрик','В',2,0,'1212987325','13:12:2004'),(48,'Даниил','Юрик','Владимрович',2,0,'1299023903','13:12:2004');
...
CREATE TABLE `orders` (
  ...
  `OrderCarId` int(11) NOT NULL,
  `OrderDriverId` int(11) NOT NULL,
  `OrderOwnerId` int(11) NOT NULL,
  `OrderPolicyholderId` int(11) NOT NULL,
  `Cost` varchar(45) NOT NULL,
  `Prem` varchar(45) NOT NULL,
  PRIMARY KEY (`OrderId`),
  KEY `OrderDriverId_idx` (`OrderDriverId`),
  KEY `OrderCarId_idx` (`OrderCarId`),
  KEY `OrderOwnerId_idx` (`OrderOwnerId`),
  KEY `OrderPolicyholderId_idx` (`OrderPolicyholderId`),
  CONSTRAINT `OrderCarId` FOREIGN KEY (`OrderCarId`) REFERENCES `clientscar` (`idClientsCar`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `OrderDriverId` FOREIGN KEY (`OrderDriverId`) REFERENCES `driver` (`idDriver`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `OrderOwnerId` FOREIGN KEY (`OrderOwnerId`) REFERENCES `owner` (`idOwner`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `OrderPolicyholderId` FOREIGN KEY (`OrderPolicyholderId`) REFERENCES `policyholder` (`idpolicyholder`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `orders` VALUES (22,17,46,10,10,'11122,8','1'),(24,19,48,12,12,'18018,936','1');
...
CREATE TABLE `owner` (
  ...
  `OwnerSurname` varchar(45) NOT NULL,
  `OwnerName` varchar(45) NOT NULL,
  `OwnerPatronymic` varchar(45) NOT NULL,
  `OwnerDateofbirth` varchar(45) NOT NULL,
  `OwnerPassport` text NOT NULL,
  `OwnerPassportDate` varchar(45) NOT NULL,
  `OwnerRegistrationAddress` varchar(45) NOT NULL,
  PRIMARY KEY (`idOwner`)
...
INSERT INTO `owner` VALUES (10,'В','В','В','13:13:2004','9878697812','13:12:2020','В'),(12,'Даниил','Юрик','Владимирович','13:12:2004','1123123123','12:31:2411','Юрик');
...
CREATE TABLE `policyholder` (
  `idpolicyholder` int(11) NOT NULL AUTO_INCREMENT,
  `PolicyholderName` varchar(45) NOT NULL,
  `PolicyholderSurname` varchar(45) NOT NULL,
  `PolicyholderPatronymic` varchar(45) NOT NULL,
  `PolicyholderDateofbirth` varchar(45) NOT NULL,
  `PolicyholderPassport` varchar(45) NOT NULL,
  `PolicyholderPassportDate` varchar(45) NOT NULL,
  `PolicyholderRegAddres` varchar(45) NOT NULL,
  PRIMARY KEY (`idpolicyholder`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `policyholder` VALUES (10,'В','В','В','13:13:2004','9878697812','13:12:2020','В'),(12,'Даниил','Юрик','Владимирович','13:12:2004','1123123123','12:31:2411','Юрик');
...
--
-- Dumping events for database 'osago'
--

--
-- Dumping routines for database 'osago'
--
...
-- Dump completed on 2023-04-16 23:35:52
